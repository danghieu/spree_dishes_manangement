...
module Spree
  class Product < Spree::Base
    ...
    has_many :products_ingredients, :class_name => "Dish::ProductsIngredient", foreign_key: 'product_id'
    has_many :ingredients,
             :through => :products_ingredients, :class_name => "Dish::Ingredient"
    ...
    has_many :products_nutritions, :class_name => "Dish::ProductsNutrition", foreign_key: 'product_id'
    has_many :nutritions,
             :through => :products_nutritions, :class_name => "Dish::Nutrition"
